...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"contact\": () => (/* binding */ contact)\n/* harmony export */ });\nfunction contact() {\n    const content = document.querySelector('#content');\n    \n    //header\n    const header = document.createElement('header');\n    header.classList.add('header');\n    content.appendChild(header);\n\n    const homeButton = document.createElement('button');\n    homeButton.classList.add('button');\n    homeButton.setAttribute('id', 'home-button');\n    header.appendChild(homeButton);\n    homeButton.textContent = 'HOME';\n\n    const carteButton = document.createElement('button');\n    carteButton.classList.add('button');\n    carteButton.setAttribute('id', 'menu-button');\n    header.appendChild(carteButton);\n    carteButton.textContent = 'MENU';\n\n    const contactButton = document.createElement('button');\n    contactButton.classList.add('button');\n    contactButton.setAttribute('id', 'contact-button');\n    header.appendChild(contactButton);\n    contactButton.textContent = 'CONTACT'; \n\n    //main\n\n    const main = document.createElement('main');\n    content.appendChild(main);\n\n    const mainContent = document.createElement('section'); \n    mainContent.innerHTML = `\n        <h1>Contact us</h1>\n        <ul>\n            <li>Address: Via Venezia 3</li>\n            <li>Phone: +123456789</li>\n            <li>Facebook: ...</li>\n        </ul>\n    `;\n    main.appendChild(mainContent);\n}\n\n//# sourceURL=webpack:///./src/contact.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ home)\n/* harmony export */ });\nfunction home() {\n    const content = document.querySelector('#content');\n    \n    //header\n    const header = document.createElement('header');\n    header.classList.add('header');\n    content.appendChild(header);\n\n    const homeButton = document.createElement('button');\n    homeButton.classList.add('button');\n    homeButton.setAttribute('id', 'home-button');\n    header.appendChild(homeButton);\n    homeButton.textContent = 'HOME';\n\n    const carteButton = document.createElement('button');\n    carteButton.classList.add('button');\n    carteButton.setAttribute('id', 'menu-button');\n    header.appendChild(carteButton);\n    carteButton.textContent = 'MENU';\n\n    const contactButton = document.createElement('button');\n    contactButton.classList.add('button');\n    contactButton.setAttribute('id', 'contact-button');\n    header.appendChild(contactButton);\n    contactButton.textContent = 'CONTACT'; \n\n    //main\n\n    const main = document.createElement('main');\n    content.appendChild(main);\n\n    const mainContent = document.createElement('section'); \n    mainContent.innerHTML = `\n        <h1>Alla Nonna</h1>\n        <p>The Best Italian Home Made Food</p>\n    `;\n    main.appendChild(mainContent);\n    \n}\n\n\n\n//# sourceURL=webpack:///./src/home.js?");
...
eval("module.exports = __webpack_require__.p + \"130d7e265b30a8969c56.png\";\n\n//# sourceURL=webpack:///./src/images/background.png?");
